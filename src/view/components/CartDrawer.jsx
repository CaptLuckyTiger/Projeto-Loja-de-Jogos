  ...
  return (
    <aside className="cart-drawer">
      <div className="section-heading">
        ...
        <span className="cart-count">{store.cartCount} itens</span>
      </div>
      {store.cart.length === 0 ? (
        <p className="empty-state">Seu carrinho ainda está vazio.</p>
      ) : (
        <>
          {store.cart.map((item) => (
          ...
          <Link className="primary-button full-button" to="/carrinho">
